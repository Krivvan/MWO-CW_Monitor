...
class CWmonitor(QWidget):
    ...
    def setup(self):
      ...
      self.defendTable.setHorizontalHeaderLabels("Planet Defender Territories Attacker".split())
      ...
      self.attackTable.setHorizontalHeaderLabels("Planet Attacker Territories Defender".split())      
    ...
    def addToDefendTable(self, planetInfo):
      ...
      contestedItem = QTableWidgetItem(planetInfo["territories"][0])
